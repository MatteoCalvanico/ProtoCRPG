...
# Combat Buttons
@onready var _attack_button = $CombatContainer/CombatButtons/Attack
@onready var _skip_button = $CombatContainer/CombatButtons/Skip
...
func _ready() -> void:
	...
	_display.mouse_filter = MOUSE_FILTER_IGNORE # Block scroll with mouse wheel 
